$(function() {
	$(".g-form").submit(function (event) {
		...
		let appLink = "https://script.google.com/macros/s/AKfycbwYiRPq_4fPoOqrCA4Ay6f1To9lGMYW-euPZhx56f2RaeEIkzFABqJvYWBYYah_KCMvMQ/exec";

		// Сообщение при успешной отправке данных
		let successRespond = 'Сообщение успешно отправлено. Посмотрите результат <a target="_blank" href="https://docs.google.com/spreadsheets/d/1qzzekKdALF2gxaWoO-WiSVbbYh9SSa526CAcM02HlKw/edit#gid=0">тут</a>';
